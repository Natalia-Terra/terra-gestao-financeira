...
(function () {
  ...
  function css() {
    ...
    t.textContent = [
      ...
      /* Tipografia da sidebar normalizada (compacta e uniforme) */
      ".sidebar .sb-group-header{color:var(--wood-txt2) !important;font-weight:700;font-size:13.5px !important;letter-spacing:.02em;}",
      ".sidebar .sb-group-header .sb-label{font-size:13.5px !important;}",
      ".sidebar .sb-sub,.sidebar .sb-item{color:#E7D8BF !important;border-radius:8px;font-size:12.5px !important;}",
      ".sidebar .sb-sub .sb-label,.sidebar .sb-item .sb-label{font-size:12.5px !important;line-height:1.25;}",
      ".sidebar .sb-sub:hover,.sidebar .sb-item:hover,.sidebar .sb-group-header:hover{background:rgba(255,255,255,.08) !important;}",
      ".sidebar .sb-icon svg{stroke:#D9C09A !important;width:18px;height:18px;}",
